...
import com.example.myunittestapplication.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.emailTV, 1);
        sViewsWithIds.put(R.id.btn, 2);
        sViewsWithIds.put(R.id.testBtn, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.myunittestapplication.MainViewModal) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.myunittestapplication.MainViewModal ViewModel) {
